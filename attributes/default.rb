...
default['tomcat-all']['java_home'] = '/home/myapp/apps/jdk1.8.0_65/'
default['tomcat-all']['java_path'] = '/home/myapp/apps/jdk1.8.0_65/jre/bin'

default['tomcat-all']['user'] = 'myapp'
default['tomcat-all']['group'] = 'myapp'

# Tomcat related settings
## installation
default['tomcat-all']['version'] = '7.0.53'
default['tomcat-all']['tomcat_home'] = '/home/myapp/apps/tomcat'
